...
const sections = [
  {
    title: 'Кто мы',
    body: 'Сайт «Чат-Общага» принадлежит и управляется Media-группой Siberia Art Ltd. Мы отвечаем за обработку персональных данных пользователей сайта и стараемся собирать их по минимуму.',
  },
  {
