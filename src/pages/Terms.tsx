...
const sections = [
  {
    ...
    body: 'Это соглашение регулирует использование сайта «Чат-Общага», который принадлежит и управляется Media-группой Siberia Art Ltd. Регистрируясь и пользуясь сайтом, вы подтверждаете, что прочитали соглашение и согласны с ним. Не согласны — просто не пользуйтесь сайтом.',
  },
  {
