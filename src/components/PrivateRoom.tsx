  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col bg-card">
      <div className="mx-auto flex w-full min-h-0 flex-1 flex-col items-center justify-center px-3 py-4 md:px-4 md:py-4">
        <div className="flex min-h-0 w-full flex-1 flex-col overflow-hidden border-2 border-sky-400 bg-background md:m-auto md:aspect-[16/9] md:h-full md:max-h-full md:w-auto md:max-w-full md:flex-none">
