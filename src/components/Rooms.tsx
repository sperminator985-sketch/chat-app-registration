...
const Rooms = ({ activeRoom, onPick }: RoomsProps) => {
  ...
  <section
    id="etazhi"
    className="mx-auto flex max-w-[1400px] scroll-mt-[var(--top-offset,4.5rem)] flex-col justify-start px-5 pb-16 pt-6 md:px-10 md:pb-20 md:pt-10"
  >
    ...
    <p className="mx-auto mt-4 text-center text-[clamp(0.5rem,1.32vw,1.02rem)] leading-[1.45] text-muted-foreground md:whitespace-nowrap">
