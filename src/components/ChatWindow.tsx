  ...
  return (
    ...
    >
      <div className="flex w-full min-h-0 flex-1 flex-col px-1 pb-1 pt-0 md:px-0 md:py-0">
        <div className="relative grid min-h-0 w-full flex-1 gap-[2px] overflow-hidden border-2 border-t-0 border-foreground/35 bg-foreground/35 lg:grid-cols-[1fr_280px]">
