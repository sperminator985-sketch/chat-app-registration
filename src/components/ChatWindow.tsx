  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full min-h-0 max-w-[1400px] flex-1 flex-col items-center justify-center px-3 py-4 md:px-6 md:py-6">
        <div className="grid min-h-0 w-full flex-1 gap-[2px] overflow-hidden border-2 border-foreground/35 bg-foreground/35 md:m-auto md:aspect-[16/9] md:max-h-full md:flex-none lg:grid-cols-[1fr_280px]">
