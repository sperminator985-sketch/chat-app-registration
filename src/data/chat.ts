...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    floor: '06',
    title: 'Флирт',
    about: 'Кто с какого этажа, кто кому улыбнулся в коридоре. Знакомимся вежливо.',
    online: 96,
    icon: 'Heart',
  },
  {
...
export const roomMessages: Record<string, Message[]> = {
  ...
  flirt: [
    { id: 1, nick: 'система', color: 8, time: '22:14', text: 'Вы вошли на этаж 06 — Флирт', system: true },
  ...
  noch: [
    { id: 1, nick: 'система', color: 8, time: '03:12', text: 'Вы вошли на этаж 07 — Ночная', system: true },
...
export const stats = [
  ...
  { value: '7', label: 'этажей с комнатами' },
