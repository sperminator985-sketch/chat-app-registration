...
export const roomMessages: Record<string, Message[]> = {
  ...
  sex: [
    { id: 1, nick: 'система', color: 8, time: '23:40', text: 'Вы вошли на этаж 07 — Секс 18+. Только для совершеннолетних.', system: true },
  ...
  noch: [
    { id: 1, nick: 'система', color: 8, time: '03:12', text: 'Вы вошли на этаж 08 — Ночная', system: true },
...
export const stats = [
  ...
  { value: '8', label: 'этажей с комнатами' },
